...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 2, name: 'Helium', weight: 4.0026, symbol: 'He' , symbols:'M'},
  {position: 3, name: 'Lithium', weight: 6.941, symbol: 'Li' , symbols:'L'},
  {position: 4, name: 'Beryllium', weight: 9.0122, symbol: 'Be' , symbols:'O'},
  {position: 5, name: 'Boron', weight: 10.811, symbol: 'B' , symbols:'G'},
  {position: 6, name: 'Carbon', weight: 12.0107, symbol: 'C', symbols:'A'},
  {position: 7, name: 'Nitrogen', weight: 14.0067, symbol: 'N', symbols:'G'},
  {position: 8, name: 'Oxygen', weight: 15.9994, symbol: 'O', symbols:'O'},
